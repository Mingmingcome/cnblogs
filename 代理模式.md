...
![静态代理](https://github.com/Mingmingcome/cnblogs/blob/master/images/proxy-static-proxy.jpg?raw=true)
...
下面是JDK的动态代理：
![动态代理](https://github.com/Mingmingcome/cnblogs/blob/master/images/proxy-dynamic-proxy.jpg?raw=true)
...
![invocation-handler](https://github.com/Mingmingcome/cnblogs/blob/master/images/proxy-invocation-handler.jpg?raw=true)
...
![CGLIB动态代理](https://github.com/Mingmingcome/cnblogs/blob/master/images/proxy-cglib-proxy.jpg?raw=true)
...
![method-interceptor](https://github.com/Mingmingcome/cnblogs/blob/master/images/proxy-method-interceptor.jpg?raw=true)
